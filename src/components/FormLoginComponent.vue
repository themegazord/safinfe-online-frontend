...
<style scoped>
  @media screen and (max-width: 2560px) {
    form {
      display: flex;
      padding: calc(4.3125rem * 2560 / 1920) calc(7.5rem * 2560 / 1920) calc(4.5rem * 2560 / 1920) calc(7.5rem * 2560 / 1920);
    ...
    .titulo-subtitulo {
      color: var(--darkblue);
      font-family: DM Sans;
      font-size: calc(.875rem * 2560 / 1920);
      font-style: normal;
      font-weight: 700;
      line-height: normal;
    }
  ...
  @media screen and (max-width: 1920px) {
    form {
      display: flex;
      padding: calc(4.3125rem * 1920 / 1920) calc(7.5rem * 1920 / 1920) calc(4.5rem * 1920 / 1920) calc(7.5rem * 1920 / 1920);
      flex-direction: column;
      justify-content: center;
      align-items: center;
      background: #FFF;
    ...
    .titulo-subtitulo {
      color: var(--darkblue);
      font-family: DM Sans;
      font-size: calc(.875rem * 1920 / 1920);
      font-style: normal;
      font-weight: 700;
      line-height: normal;
    }
  ...
  @media screen and (max-width: 1600px) {
    form {
      display: flex;
      padding: calc(4.3125rem * 1600 / 1920) calc(7.5rem * 1600 / 1920) calc(4.5rem * 1600 / 1920) calc(7.5rem * 1600 / 1920);
      flex-direction: column;
      justify-content: center;
      align-items: center;
      background: #FFF;
    ...
    .titulo-subtitulo {
      color: var(--darkblue);
      font-family: DM Sans;
      font-size: calc(.875rem * 1600 / 1920);
      font-style: normal;
      font-weight: 700;
      line-height: normal;
    }
  ...
  @media screen and (max-width: 1440px) {
    form {
      display: flex;
      padding: calc(4.3125rem * 1440 / 1920) calc(7.5rem * 1440 / 1920) calc(4.5rem * 1440 / 1920) calc(7.5rem * 1440 / 1920);
      flex-direction: column;
      justify-content: center;
      align-items: center;
      background: #FFF;
    ...
    .titulo-subtitulo {
      color: var(--darkblue);
      font-family: DM Sans;
      font-size: calc(.875rem * 1440 / 1920);
      font-style: normal;
      font-weight: 700;
      line-height: normal;
    }
  ...
  @media screen and (max-width: 1366px) {
    form {
      display: flex;
      padding: calc(4.3125rem * 1366 / 1920) calc(7.5rem * 1366 / 1920) calc(4.5rem * 1366 / 1920) calc(7.5rem * 1366 / 1920);
      flex-direction: column;
      justify-content: center;
      align-items: center;
      background: #FFF;
    ...
    .titulo-subtitulo {
      color: var(--darkblue);
      font-family: DM Sans;
      font-size: calc(.875rem * 1366 / 1920);
      font-style: normal;
      font-weight: 700;
      line-height: normal;
    }
  ...
  @media screen and (max-width: 1280px) {
    form {
      display: flex;
      padding: calc(4.3125rem * 1280 / 1920) calc(7.5rem * 1280 / 1920) calc(4.5rem * 1280 / 1920) calc(7.5rem * 1280 / 1920);
      flex-direction: column;
      justify-content: center;
      align-items: center;
      background: #FFF;
  ...
  @media screen and (max-width: 1024px) {
    form {
      display: flex;
      padding: calc(4.3125rem * 1300 / 1920) calc(7.5rem * 1300 / 1920) calc(4.5rem * 1300 / 1920) calc(7.5rem * 1300 / 1920);
      flex-direction: column;
      justify-content: center;
      align-items: center;
      background: #FFF;
